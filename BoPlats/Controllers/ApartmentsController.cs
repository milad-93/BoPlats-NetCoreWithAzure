...
namespace BoPlats.Controllers
{
    public class ApartmentsController : Controller
    {
        ...
        public ApartmentsController(DataContext_Milad context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Adress,Elevator,NumberOfRooms,Balcony,SquareMeter,Floor,Rent,RegisterTime")] Apartment apartment)
        {
            if (id != apartment.Id)
            {
                return NotFound();
